        ...
        for (int i = 0; i < secondSplited.size(); i++) {
            ...
            for (int j = 0; j < steps; j++){
                ...
                for (int k = 0; k < path1.size(); k++){
                    if (path1.contains(p.toString()) && p.getDistanceFromO() < minDistance){
                        minDistance = p.getDistanceFromO();
                    }
                }
            }
        }
        System.out.println("Closest intersection: " +minDistance);
    }
}
